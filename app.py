...
def render_dashboard():
    ...
    with col_logo:
        ...
        if os.path.exists(logo_path):
            ...
            st.markdown(f"<img src='data:image/jpeg;base64,{encoded_string}' style='width: 100px; height: 100px; border-radius: 50%; object-fit: cover; border: 2px solid #01FF84; box-shadow: 0 0 10px rgba(1, 255, 132, 0.3); margin-top: 5px;'/>", unsafe_allow_html=True)
        else:
...
def render_landing_page():
    ...
    if os.path.exists(logo_path):
        ...
        with open(logo_path, "rb") as image_file:
            encoded_string = base64.b64encode(image_file.read()).decode()
        logo_html = f"<img src='data:image/jpeg;base64,{encoded_string}' style='width: 150px; height: 150px; border-radius: 50%; object-fit: cover; border: 3px solid #01FF84; margin-bottom: 20px; box-shadow: 0 0 25px rgba(1, 255, 132, 0.4);'/>"
    else:
